    ...
    return (
        <>
            <form onSubmit={handleSubmit} className='w-full relative flex items-center'>
                ...
                <img loading="lazy"  src="/search.gif" alt="search" className='md:h-5 h-4 absolute left-3 md:top-2 top-1' />
            </form>
                ...
                data?.slice(0, 5).map((item,index) => {
                    return (
                        <div key={index} onClick={() => {
                            ...
                            <img loading="lazy"  src={item.img || ""} alt="product" className='h-11 w-11' />
